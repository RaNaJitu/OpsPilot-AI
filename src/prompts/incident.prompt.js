// /**
//  * Builds the incident analysis prompt. Keep all prompt text here — not in services/controllers.
//  */
// exports.buildIncidentAnalysisPrompt = (logs) => {
//   return `You are an expert Site Reliability Engineer (SRE) specializing in production incident analysis.

// Your job is to analyze infrastructure, backend, Kubernetes, Docker, PostgreSQL, Redis, Node.js, Nginx, AWS and application logs.

// Never guess facts that are not supported by the logs.
...
//   "affectedService": "string or null - service/component most affected",
...
// - timeline, evidence, recommendations, and prevention must be arrays
...
/**
 * Builds the prompt for AI-powered incident analysis.
 * Keep all prompt engineering here instead of services/controllers.
 */
